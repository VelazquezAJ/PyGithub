...
class Logging(Framework.BasicTestCase):
    ...
    def testLoggingWithBasicAuthentication(self):
        self.assertEqual(pygithub.Github(self.login, self.password).get_user().name, "Vincent Jacques")
    ...
    def testLoggingWithOAuthAuthentication(self):
        self.assertEqual(pygithub.Github(self.oauth_token).get_user().name, "Vincent Jacques")
        if atMostPython32:
    ...
    def testLoggingWithBaseUrl(self):
        ...
        self.assertEqual(pygithub.Github(base_url="http://my.enterprise.com/my/prefix").get_user("jacquev6").name, "Vincent Jacques")
        if atMostPython32:
